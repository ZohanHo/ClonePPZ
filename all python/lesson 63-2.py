...
class SchoolMember(metaclass=ABCMeta):
    ...
    @abstractmethod # запретим создавать экземпляры класса SchoolMember
    def tell(self):
        '''Вывести информацию.'''
...
"""
Мы можем объявить метод tell класса SchoolMember абстрактным, и таким образом автоматически
запретим создавать экземпляры класса SchoolMember.
