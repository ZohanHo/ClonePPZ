class Phone:
    ...
    def call(self):  #self говорит что при вызое метода от определенного обьекта, он будет использоватся для него
...
# self в методе ссылается на обьект которым он вызван, и при создании обьекта был инициализирован конструктор соотетственно
